...
//     }
  ...
  //     FW_ASSERT(ptr);
  //     ATmegaGpioDriverComponentImpl* compPtr = (ATmegaGpioDriverComponentImpl*) ptr;
  ...
  //     Os::Task::TaskStatus stat = this->m_intTask.start(name,0,priority,20*1024,ATmegaGpioDriverComponentImpl::intTaskEntry,this,cpuAffinity);
