...
#if F_CPU == 7372800L
#define MICROSECONDS_PER_TIMER0_OVERFLOW 2222 // Real value is 2222.22... but this is more precise than clockCyclesToMicroseconds() which truncates 7.3728 -> 7, leading to 5% speedup error
#else
